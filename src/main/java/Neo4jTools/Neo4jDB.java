...
public class Neo4jDB {
    ...
    public void startDB(boolean getProperties) {
        ...
        GraphDatabaseBuilder builder = new GraphDatabaseFactory().newEmbeddedDatabaseBuilder(new File(this.DB_PATH)).loadPropertiesFromFile("/home/gqxwolf/neo4j348/conf/neo4j.conf");
